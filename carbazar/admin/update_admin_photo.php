...
<?php
				...
				if(isset($_POST['submit'])){
					...
					$imga=$_FILES['admin_photo']['name'];
					$imgsrc2="admin_img/".$imga;
					move_uploaded_file($_FILES['admin_photo']['tmp_name'],$imgsrc2);
					$old_image=imagecreatefromjpeg("admin_img/".$imga);
					...
					imagecopyresized($new_image,$old_image,0,0,0,0,$new_w,$new_h,$old_width,$old_height);
									
					$imgsrc="admin_img/".$_SESSION['admin_id'].".jpg";
					imagejpeg($new_image,$imgsrc);
										
					unlink($imgsrc2);
				///	move_uploaded_file($_FILES['admin_photo']['tmp_name'],$imgsrc);
						include("connection.php");
					$sql="update login set image_src='$imgsrc' where id=$aid";
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h2> <?php echo $_SESSION['admin_id']." "; ?> Set Your Profile Picture </h2>
                    </div>
                </div>
                  <hr />
			  ...
			  <table width="70%">
					...
					<tr>
					<td width="30%"><font size="4">Select Image :</font></td>
					<td width="30%">
										    
						
						<input type="file" name="admin_photo" class="btn btn-file btn-primary">
					...
					<input type="submit" class="btn btn-primary" name="submit" value="Set This Photo">
