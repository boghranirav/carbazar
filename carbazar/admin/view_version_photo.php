...
if(isset($_POST['m_id'])){
	...
	include("connection.php");
								...
								while($row=mysql_fetch_array($sql1)){
									...
									$id=$row['photo_id'];
									$pho=$row['name'];
									echo "<td><div class='image'><a href='upload_car/image/".$pho."'><img src='upload_car/image/".$pho."' width='200' height='200'></a><a href='photo_delete.php?pid=$id' ><div class='stylish-button '>Delete</div></a></div></td>";
