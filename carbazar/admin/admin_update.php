       ...
       <div id="left" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h2> <?php echo $_SESSION['admin_id']." "; ?> Your Profile </h2>
                    </div>
                </div>
                  <hr />
<?php
...
?>
			  ...
			  <table>
					...
					&nbsp;&nbsp;&nbsp;
					<div class="col-lg-11">
					<input class="form-control" name="fname" size="25" value="<?php echo $row['firstname']; ?>">
					</div>
					</td>
					</tr>
					...
					&nbsp;&nbsp;&nbsp;
					<div class="col-lg-11">
					<input class="form-control" name="lname" size="25" value="<?php echo $row['lastname']; ?>">
					</div>
					</td>
					</tr>
					...
					&nbsp;&nbsp;&nbsp;
					<div class="col-lg-11">
					<input class="form-control" name="email" size="25" value="<?php echo $row['email_id']; ?>">
					</div>
					</td>
					</tr>
				...
				if(isset($_POST['submit'])){
					...
					$sql="update login set  firstname='$firstn' , lastname='$lastn',email_id='$email' where id=$aid";
