...
<head>
     <meta charset="UTF-8" />
    <title>BCORE Admin Dashboard Template | Offline Page</title>
	  ...
	  <div class="logo">
	    <h1>Hey, Even The Big Portal Has Down Time</h1>
		  ...
		  <div class="btn-group btn-group-justified">
		      <a href="index2.php" class="btn btn-primary">Contact</a>
                      <a href="index2.php" class="btn btn-success">Return Website</a>
		  </div>
