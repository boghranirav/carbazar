...
<?php
       ...
       <div id="left">
            ...
            <ul id="menu" class="collapse">
               ...
               <li class="panel active" ><a href="gallery.php"><i class="icon-film"></i> Image Gallery </a></li>
        ...
        <div id="content">
			...
			<p style="text-align:center">
				...
				<?php
					...
					$sql2="select * from photos p,car_model c where p.car_id=c.car_id";
					$res2=mysql_query($sql2);
					
					while($row2=mysql_fetch_array($res2)){
					
					$path="upload_car/image/".$row2['name'];
					$tit=$row2['car_name'];
					
						echo "<a  href='".$path."' title='".$tit."'><img src='".$path."' height='200' width='200' alt='' ></a>";
					}
