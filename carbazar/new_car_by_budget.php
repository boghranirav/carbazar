...
<div class="mens">    
  <div class="main">
	   ...
	   <div style="margin-left:1cm;">
		<table class="CSSTableGenerator">
			...
			if(isset($_GET['bud'])){
				...
				if($budid==1){
				$sql="select v_id,car_id,version_name,price from car_version where price<500000";
				}
				else
					if($budid==2)
					{
							$sql="select v_id,car_id,version_name,price from car_version where price between 500000 and 1000000";
					}
					else
						if($budid==3){
							$sql="select v_id,car_id,version_name,price from car_version where price between 1000000 and  2000000";
						}
						else
							if($budid==4){
								$sql="select v_id,car_id,version_name,price from car_version where price between 2000000 and 5000000";
							}
							else
								if($budid==5){
									$sql="select v_id,car_id,version_name,price from car_version where price between 5000000 and  10000000";
								}
								else
									if($budid==6){
										$sql="select v_id,car_id,version_name,price from car_version where price>10000000 ";
									}
			//	$sql="select * from car_version where price<300000";
				...
				while($row=mysql_fetch_array($res)){
					...
					echo "<td><a href='overview.php?vid=$vid'><font size='4'><b style='font-size:22px;color:blue;'>".$rowbn['car_company']."</b><font color='black'><br>".$row['version_name']."</font></font></a></td>";
				...
				if(isset($_POST['checkboxt2'])) 
					...
					echo "</td>";
					echo "<td><a href='overview.php?vid=$vid'><font size='4'><b style='font-size:22px;color:blue;'>".$rowbn['car_company']."</b><font color='black'><br>".$row1['version_name']."</font></font></a></td>";
					...
					echo "</tr>";
						...
						if(((isset($_POST['checkboxb1'])) || (isset($_POST['checkboxb2'])) || (isset($_POST['checkboxb3'])) || (isset($_POST['checkboxb4'])) || (isset($_POST['checkboxb5'])) || (isset($_POST['checkboxb6'])) || (isset($_POST['checkboxb7'])) || (isset($_POST['checkboxb8'])) || (isset($_POST['checkboxb9']))  || (isset($_POST['checkboxb10']))  || (isset($_POST['checkboxb11']))  || (isset($_POST['checkboxb12']))  || (isset($_POST['checkboxb13']))  || (isset($_POST['checkboxb14']))  || (isset($_POST['checkboxb15']))  || (isset($_POST['checkboxb16']))  || (isset($_POST['checkboxb17']))  || (isset($_POST['checkboxb18']))  || (isset($_POST['checkboxb19']))  || (isset($_POST['checkboxb20']))  || (isset($_POST['checkboxb21']))  || (isset($_POST['checkboxb22']))  || (isset($_POST['checkboxb23']))  || (isset($_POST['checkboxb24']))  || (isset($_POST['checkboxb25']))  || (isset($_POST['checkboxb26']))  || (isset($_POST['checkboxb27']))  || (isset($_POST['checkboxb28']))  || (isset($_POST['checkboxb29']))) && ((isset($_POST['checkboxf1'])) || (isset($_POST['checkboxf2'])) || (isset($_POST['checkboxf3']))) && ((isset($_POST['checkboxt1'])) || (isset($_POST['checkboxt2']))))
					{
					...
					echo "</tr>";
						...
						if(((isset($_POST['checkbox1'])) || (isset($_POST['checkbox2'])) || (isset($_POST['checkbox3'])) || (isset($_POST['checkbox4'])) || (isset($_POST['checkbox5'])) || (isset($_POST['checkbox6']))) && ((isset($_POST['checkboxb1'])) || (isset($_POST['checkboxb2'])) || (isset($_POST['checkboxb3'])) || (isset($_POST['checkboxb4'])) || (isset($_POST['checkboxb5'])) || (isset($_POST['checkboxb6'])) || (isset($_POST['checkboxb7'])) || (isset($_POST['checkboxb8'])) || (isset($_POST['checkboxb9']))  || (isset($_POST['checkboxb10']))  || (isset($_POST['checkboxb11']))  || (isset($_POST['checkboxb12']))  || (isset($_POST['checkboxb13']))  || (isset($_POST['checkboxb14']))  || (isset($_POST['checkboxb15']))  || (isset($_POST['checkboxb16']))  || (isset($_POST['checkboxb17']))  || (isset($_POST['checkboxb18']))  || (isset($_POST['checkboxb19']))  || (isset($_POST['checkboxb20']))  || (isset($_POST['checkboxb21']))  || (isset($_POST['checkboxb22']))  || (isset($_POST['checkboxb23']))  || (isset($_POST['checkboxb24']))  || (isset($_POST['checkboxb25']))  || (isset($_POST['checkboxb26']))  || (isset($_POST['checkboxb27']))  || (isset($_POST['checkboxb28']))  || (isset($_POST['checkboxb29']))) && ((isset($_POST['checkboxt1'])) || isset($_POST['checkboxt1'])))
					{
							if($b1==1){
					
					include("connection.php");
					$sql1="select * from car_version where price<500000 and brand_id in($brand1,$brand2,$brand3,$brand4,$brand5,$brand6,$brand7,$brand8,$brand9,$brand10,$brand11,$brand12,$brand13,$brand14,$brand15,$brand16,$brand17,$brand18,$brand19,$brand20,$brand21,$brand22,$brand23,$brand24,$brand25,$brand26,$brand27,$brand28) and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					echo "</tr>";
						...
						if(((isset($_POST['checkbox1'])) || (isset($_POST['checkbox2'])) || (isset($_POST['checkbox3'])) || (isset($_POST['checkbox4'])) || (isset($_POST['checkbox5'])) || (isset($_POST['checkbox6']))) && ((isset($_POST['checkboxf1'])) || (isset($_POST['checkboxf2'])) || (isset($_POST['checkboxf3']))) && ((isset($_POST['checkboxt1'])) || isset($_POST['checkboxt1'])))
					{
							if($b1==1){
					
					include("connection.php");
					$sql1="select * from car_version where price<500000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b2==2){
						include("connection.php");
					$sql1="select * from car_version where price between 500000 and 1000000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b3==3){
						include("connection.php");
					$sql1="select * from car_version where price between 1000000 and 2000000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b4==4){
						include("connection.php");
					$sql1="select * from car_version where price between 2000000 and 2500000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b5==5){
						include("connection.php");
					$sql1="select * from car_version where price between 5000000 and 10000000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b6==6){
						include("connection.php");
					$sql1="select * from car_version where price>10000000 and f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b6==6){
						include("connection.php");
					$sql1="select * from car_version where price>10000000 and brand_id in($brand1,$brand2,$brand3,$brand4,$brand5,$brand6,$brand7,$brand8,$brand9,$brand10,$brand11,$brand12,$brand13,$brand14,$brand15,$brand16,$brand17,$brand18,$brand19,$brand20,$brand21,$brand22,$brand23,$brand24,$brand25,$brand26,$brand27,$brand28) order by brand_id";
					...
					if(((isset($_POST['checkbox1'])) || (isset($_POST['checkbox2'])) || (isset($_POST['checkbox3'])) || (isset($_POST['checkbox4'])) || (isset($_POST['checkbox5'])) || (isset($_POST['checkbox6']))) && ((isset($_POST['checkboxt1'])) || isset($_POST['checkboxt1'])))
					{
							if($b1==1){
					
					include("connection.php");
					$sql1="select * from car_version where price<500000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b2==2){
						include("connection.php");
					$sql1="select * from car_version where price between 500000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b3==3){
						include("connection.php");
					$sql1="select * from car_version where price between 1000000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b4==4){
						include("connection.php");
					$sql1="select * from car_version where price between 2000000 and 2500000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b5==5){
						include("connection.php");
					$sql1="select * from car_version where price between 5000000 and 10000000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
					...
					if($b6==6){
						include("connection.php");
					$sql1="select * from car_version where price>10000000 and transmission in('$brand_t1','$brand_t2') order by brand_id";
				...
				if(((isset($_POST['checkboxb1'])) || (isset($_POST['checkboxb2'])) || (isset($_POST['checkboxb3'])) || (isset($_POST['checkboxb4'])) || (isset($_POST['checkboxb5'])) || (isset($_POST['checkboxb6'])) || (isset($_POST['checkboxb7'])) || (isset($_POST['checkboxb8'])) || (isset($_POST['checkboxb9']))  || (isset($_POST['checkboxb10']))  || (isset($_POST['checkboxb11']))  || (isset($_POST['checkboxb12']))  || (isset($_POST['checkboxb13']))  || (isset($_POST['checkboxb14']))  || (isset($_POST['checkboxb15']))  || (isset($_POST['checkboxb16']))  || (isset($_POST['checkboxb17']))  || (isset($_POST['checkboxb18']))  || (isset($_POST['checkboxb19']))  || (isset($_POST['checkboxb20']))  || (isset($_POST['checkboxb21']))  || (isset($_POST['checkboxb22']))  || (isset($_POST['checkboxb23']))  || (isset($_POST['checkboxb24']))  || (isset($_POST['checkboxb25']))  || (isset($_POST['checkboxb26']))  || (isset($_POST['checkboxb27']))  || (isset($_POST['checkboxb28']))  || (isset($_POST['checkboxb29']))) && ((isset($_POST['checkboxt1'])) || isset($_POST['checkboxt1'])))
				{
					...
					include("connection.php");
					$sqlbrand="select * from car_version where brand_id in($brand1,$brand2,$brand3,$brand4,$brand5,$brand6,$brand7,$brand8,$brand9,$brand10,$brand11,$brand12,$brand13,$brand14,$brand15,$brand16,$brand17,$brand18,$brand19,$brand20,$brand21,$brand22,$brand23,$brand24,$brand25,$brand26,$brand27,$brand28) and transmission in('$brand_t1','$brand_t2') order by brand_id";	
					...
					echo "<img src='admin/upload_car/image/".$rowi1['name']."' height='150px' width='150px'>";
					echo "</td>";
					echo "<td><a href='overview.php?vid=$vid'><font size='4'><b style='font-size:22px;color:blue;'>".$rowbn['car_company']."</b><font color='black'><br>".$rowbrand['version_name']."</font></font></a></td>";
					echo "<td > <font size='4'>".$rowbrand['price']."</font></td>";
					echo "</tr>";
					}
					
				}else
						if(((isset($_POST['checkboxf1'])) || (isset($_POST['checkboxf2'])) || (isset($_POST['checkboxf3']))) && ((isset($_POST['checkboxt1'])) || isset($_POST['checkboxt1']))){
					
					include("connection.php");
					$sqlbrandfuel="select * from car_version where f_type in('$brand_fual1','$brand_fual2','$brand_fual3') and transmission in('$brand_t1','$brand_t2') order by brand_id";	
					...
					echo "<img src='admin/upload_car/image/".$rowi1['name']."' height='150px' width='150px'>";
					echo "</td>";
					echo "<td><a href='overview.php?vid=$vid'><font size='4'><b style='font-size:22px;color:blue;'>".$rowbn['car_company']."</b><font color='black'><br>".$rowbrandfuel['version_name']."</font></font></a></td>";
				...
				if((isset($_POST['checkboxb1'])) || (isset($_POST['checkboxb2'])) || (isset($_POST['checkboxb3'])) || (isset($_POST['checkboxb4'])) || (isset($_POST['checkboxb5'])) || (isset($_POST['checkboxb6'])) || (isset($_POST['checkboxb7'])) || (isset($_POST['checkboxb8'])) || (isset($_POST['checkboxb9']))  || (isset($_POST['checkboxb10']))  || (isset($_POST['checkboxb11']))  || (isset($_POST['checkboxb12']))  || (isset($_POST['checkboxb13']))  || (isset($_POST['checkboxb14']))  || (isset($_POST['checkboxb15']))  || (isset($_POST['checkboxb16']))  || (isset($_POST['checkboxb17']))  || (isset($_POST['checkboxb18']))  || (isset($_POST['checkboxb19']))  || (isset($_POST['checkboxb20']))  || (isset($_POST['checkboxb21']))  || (isset($_POST['checkboxb22']))  || (isset($_POST['checkboxb23']))  || (isset($_POST['checkboxb24']))  || (isset($_POST['checkboxb25']))  || (isset($_POST['checkboxb26']))  || (isset($_POST['checkboxb27']))  || (isset($_POST['checkboxb28']))  || (isset($_POST['checkboxb29'])) )
				{
					...
					if((isset($_POST['checkboxt1'])) || (isset($_POST['checkboxt2']))){
					
					include("connection.php");
					$sqlbrandfuel="select * from car_version where transmission in ('$brand_t1','$brand_t2') order by brand_id";	
	...
	<script type="text/javascript" src="js/jquery.flexisel.js"></script>
	  ...
	  <form method="post"  name="frm" action="new_car_by_budget.php">
			    ...
			    <section  class="sky-form">
					<h4>Transmission</h4>
						<div class="row">
							...
							<div class="col col-2" style="margin-left:0.5cm">
