  ...
  <div class="wrap">
	    <h4 class="title">
		      ...
		      <div>
								...
								<td width="330px">
								<div style="border:2px solid lightblue;width:300px;height:210px;" align="center">
								<?php
		  ...
		  <div class="box"  style="width:1000px;" id="eng">
						<header>
                                <h5>ENGINE</h5>
								<div class="toolbar">
                                    <div class="btn-group">
		    ...
		    <div id="sortableTable" class="body collapse in" >
					   <div class="panel-body">
			             ...
			             <table class="table table-striped table-bordered table-hover" id="engine">
					             ...
					             $sql=mysql_query("select *from car_engine where v_id='$id1'");
					               ...
					               $sql2=mysql_query("select *from car_engine where v_id='$id2'");
					                ...
					                $row2=mysql_fetch_array($sql2);
		          	               ...
		          	               ?>
			                 <tr>
			                    <td width="300px">Engine Type</td><td width="350px"><?php echo $engtype;?></td><td width="350px"><?php echo $engtype2;?></td>
					         </tr>  
					         <tr>	  
					            <td>Engine Description</td><td><?php echo $engdec;?></td><td><?php echo $engdec2;?></td>
                             </tr>
                             <tr>					 
						       <td>Engine Displacement(cc)</td><td><?php echo $engdis;?></td><td><?php echo $engdis2;?></td>
                             </tr>
                             <tr>					  
						       <td>No.of Cylinders</td><td><?php echo $nocyl;?></td><td><?php echo $nocyl2;?></td>
						     </tr>
                             <tr>
						        <td>Maximum Power</td><td><?php echo $maxpower;?></td><td><?php echo $maxpower2;?></td>
			                 </tr>
							 <tr>
		  ...
		  <div class="box"  style="width:1000px;" id="tran" >
						<header>
                                <h5>TRANSMISSION</h5>
								<div class="toolbar">
                                    <div class="btn-group">
		    ...
		    <div id="sortableTable1" class="body collapse in" >
					   <div class="panel-body">
					      <div class="table-responsive">
			             <table class="table table-striped table-bordered table-hover" id="transmission">
...
<div class="box"  style="width:1000px;" >
	    ...
	    <div class="box"  style="width:1000px;" id="fuel">
						<header>
                                <h5>FUEL</h5>
								<div class="toolbar">
                                    <div class="btn-group">
		    ...
		    <div id="sortableTable6" class="body collapse in" >
					   <div class="panel-body">
					      <div class="table-responsive">
			             <table class="table table-striped table-bordered table-hover" id="fuel">
								...
								$row2=mysql_fetch_array($sql2);
		          	               ...
		          	               ?>
			                 <tr >
			                    <td width="300px">Mileage-City</td><td width="350px"><?php echo $mc;?></td><td width="350px"><?php echo $mc2;?></td>
					         </tr>  
					         <tr>	  
		    ...
		    <div id="sortableTable12" class="body collapse in" >
					   <div class="panel-body">
			             ...
			             <table class="table table-striped table-bordered table-hover" >
							...
							<tr>					  
						       <td>Rear Spoiler</td><td><?php echo $rear_spoiler;?></td><td><?php echo $rear_spoiler2;?></td>
						    </tr>
							<tr>					  
							...
							<tr>					  
						       <td>Outside Rear View Mirror Turn Indicators</td><td><?php echo $outside_mirror_i;?></td><td><?php echo $outside_mirror_i2;?></td>
						    </tr>
							<tr>					  
